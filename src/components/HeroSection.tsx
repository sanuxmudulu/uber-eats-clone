  ...
  return (
    <section className="flex flex-col items-center px-4 pt-7 pb-5 text-center">
      ...
      <a
        ...
        className="mb-2 flex w-full max-w-md items-center justify-center rounded-full bg-accent px-6 py-4 text-white text-xl md:text-2xl font-bold shadow-lg transition-all duration-200 hover:scale-[1.02]"
        >
        Claim Now
      </a>
    </section>
